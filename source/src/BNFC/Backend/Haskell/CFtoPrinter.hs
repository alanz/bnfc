...
cf2Printer incremental byteStrings functor useGadt name absMod cf = unlines [
  prologue incremental byteStrings useGadt name absMod,
  integerRule cf,
  doubleRule cf,
...
prologue :: Bool -> Bool -> Bool -> String -> String -> String
prologue incremental byteStrings useGadt name absMod = unlines $
...
identRule incremental byteStrings cf = ownPrintRule incremental byteStrings cf catIdent
